...
#define ML_0(namespace, cname, conv) \
CAMLprim value ml_gi##namespace##_##cname (value unit) { return conv (cname ()); }
#define ML_1(namespace, cname, conv1, conv) \
CAMLprim value ml_gi##namespace##_##cname (value arg1) { return conv (cname (conv1 (arg1))); }
#define ML_1_post(namespace, cname, conv1, conv, post) \
CAMLprim value ml_gi##namespace##_##cname (value arg1) \
{ value ret = conv (cname (conv1(arg1))); post; return ret; }
#define ML_2(namespace, cname, conv1, conv2, conv) \
...
{ return conv (cname (conv1(arg1), conv2(arg2))); }
#define ML_3(namespace, cname, conv1, conv2, conv3, conv) \
...
{ return conv (cname (conv1(arg1), conv2(arg2), conv3(arg3))); }
#define ML_4(namespace, cname, conv1, conv2, conv3, conv4, conv) \
...
{ return conv (cname (conv1(arg1), conv2(arg2), conv3(arg3), conv4(arg4))); }
#define ML_5(namespace, cname, conv1, conv2, conv3, conv4, conv5, conv) \
CAMLprim value ml_gi##namespace##_##cname (value arg1, value arg2, value arg3, value arg4, \
                           value arg5) \
{ return conv (cname (conv1(arg1), conv2(arg2), conv3(arg3), conv4(arg4), \
		      conv5(arg5))); }
...
{ return conv (cname (conv1(arg1), conv2(arg2), conv3(arg3), conv4(arg4), \
		      conv5(arg5))); }
#define ML_6(namespace, cname, conv1, conv2, conv3, conv4, conv5, conv6, conv) \
CAMLprim value ml_gi##namespace##_##cname (value arg1, value arg2, value arg3, value arg4, \
                           value arg5, value arg6) \
{ return conv (cname (conv1(arg1), conv2(arg2), conv3(arg3), conv4(arg4), \
		      conv5(arg5), conv6(arg6))); }
#define ML_7(namespace, cname, conv1, conv2, conv3, conv4, conv5, conv6, conv7, conv) \
CAMLprim value ml_gi##namespace##_##cname (value arg1, value arg2, value arg3, value arg4, \
                           value arg5, value arg6, value arg7) \
{ return conv (cname (conv1(arg1), conv2(arg2), conv3(arg3), conv4(arg4), \
		      conv5(arg5), conv6(arg6), conv7(arg7))); }
#define ML_8(namespace, cname, conv1, conv2, conv3, conv4, conv5, conv6, conv7, conv8, \
	     conv) \
CAMLprim value ml_gi##namespace##_##cname (value arg1, value arg2, value arg3, value arg4, \
                           value arg5, value arg6, value arg7, value arg8) \
{ return conv (cname (conv1(arg1), conv2(arg2), conv3(arg3), conv4(arg4), \
		      conv5(arg5), conv6(arg6), conv7(arg7), conv8(arg8))); }
#define ML_9(namespace, cname, conv1, conv2, conv3, conv4, conv5, conv6, conv7, conv8, \
	      conv9, conv) \
CAMLprim value ml_gi##namespace##_##cname (value arg1, value arg2, value arg3, value arg4, \
                           value arg5, value arg6, value arg7, value arg8, \
                           value arg9) \
...
{ return conv (cname (conv1(arg1), conv2(arg2), conv3(arg3), conv4(arg4), \
		      conv5(arg5), conv6(arg6), conv7(arg7), conv8(arg8), \
		      conv9(arg9))); }
#define ML_10(namespace, cname, conv1, conv2, conv3, conv4, conv5, conv6, conv7, conv8, \
	      conv9, conv10, conv) \
CAMLprim value ml_gi##namespace##_##cname (value arg1, value arg2, value arg3, value arg4, \
                           value arg5, value arg6, value arg7, value arg8, \
...
#define ML_11(namespace, cname, conv1, conv2, conv3, conv4, conv5, conv6, conv7, conv8, \
...
#define ML_12(namespace, cname, conv1, conv2, conv3, conv4, conv5, conv6, conv7, conv8, \
...
{ return conv (cname (conv1(arg1), conv2(arg2), conv3(arg3), conv4(arg4), \
		      ...
		      conv9(arg9), conv10(arg10), conv11(arg11), \
		      conv12(arg12))); }
#define ML_13(namespace, cname, conv1, conv2, conv3, conv4, conv5, conv6, conv7, conv8, \
...
#define ML_1in_1out(namespace, cname, conv1in, cType1out, conv1out, convRes) \
CAMLprim value ml_gi##namespace##_##cname (value arg1) \
{ \
    CAMLparam1(arg1); CAMLlocal1(tuple); \
    cType1out a; tuple = alloc_tuple(2); \
    value res = convRes(cname(conv1in(arg1), &a)); \
    Store_field(tuple, 0, res); Store_field(tuple, 1, conv1out(a));\
    CAMLreturn (tuple); \
}

#define ML_1in_2out(namespace, cname, conv1in, cType1out, conv1out, cType2out, conv2out, convRes) \
CAMLprim value ml_gi##namespace##_##cname (value arg1) \
{ \
    CAMLparam1(arg1); CAMLlocal1(tuple); \
    cType1out a; cType2out b; tuple = alloc_tuple(3); \
    value res = convRes(cname(conv1in(arg1), &a, &b)); \
    Store_field(tuple, 0, res); Store_field(tuple, 1, conv1out(a)); Store_field(tuple, 2, conv2out(b)); \
    CAMLreturn (tuple); \
}

#define ML_1in_3out(namespace, cname, conv1in, cType1out, conv1out, cType2out, conv2out, cType3out, conv3out, convRes) \
CAMLprim value ml_gi##namespace##_##cname (value arg1) \
{ \
    CAMLparam1(arg1); CAMLlocal1(tuple); \
    cType1out a; cType2out b; cType3out c; tuple = alloc_tuple(4); \
    value res = convRes(cname(conv1in(arg1), &a, &b, &c)); \
    Store_field(tuple, 0, res); Store_field(tuple, 1, conv1out(a)); Store_field(tuple, 2, conv2out(b)); Store_field(tuple, 3, conv3out(c)); \
    CAMLreturn (tuple); \
}

#define ML_1in_4out(namespace, cname, conv1in, cType1out, conv1out, cType2out, conv2out, cType3out, conv3out, cType4out, conv4out, convRes) \
CAMLprim value ml_gi##namespace##_##cname (value arg1) \
{ \
    CAMLparam1(arg1); CAMLlocal1(tuple); \
    cType1out a; cType2out b; cType2out c; cType2out d; tuple = alloc_tuple(5); \
    value res = convRes(cname(conv1in(arg1), &a, &b, &c, &d)); \
...
#define ML_2in_1out(namespace, cname, conv1in, conv2in, cType1out, conv1out, convRes) \
CAMLprim value ml_gi##namespace##_##cname (value arg1, value arg2) \
{ \
    CAMLparam2(arg1, arg2); CAMLlocal1(tuple); \
    cType1out a; tuple = alloc_tuple(2); \
    value res = convRes(cname(conv1in(arg1), conv2in(arg2), &a)); \
    Store_field(tuple, 0, res); Store_field(tuple, 1, conv1out(a));\
    CAMLreturn (tuple); \
}

#define ML_2in_2out(namespace, cname, conv1in, conv2in, cType1out, conv1out, cType2out, conv2out, convRes) \
CAMLprim value ml_gi##namespace##_##cname (value arg1, value arg2) \
{ \
    CAMLparam2(arg1, arg2); CAMLlocal1(tuple); \
    cType1out a; cType2out b; tuple = alloc_tuple(3); \
    value res = convRes(cname(conv1in(arg1), conv2in(arg2), &a, &b)); \
    Store_field(tuple, 0, res); Store_field(tuple, 1, conv1out(a)); Store_field(tuple, 2, conv2out(b)); \
    CAMLreturn (tuple); \
}

#define ML_2in_3out(namespace, cname, conv1in, conv2in, cType1out, conv1out, cType2out, conv2out, cType3out, conv3out, convRes) \
CAMLprim value ml_gi##namespace##_##cname (value arg1, value arg2) \
{ \
    CAMLparam2(arg1, arg2); CAMLlocal1(tuple); \
    cType1out a; cType2out b; cType3out c; tuple = alloc_tuple(4); \
    value res = convRes(cname(conv1in(arg1), conv2in(arg2), &a, &b, &c)); \
    Store_field(tuple, 0, res); Store_field(tuple, 1, conv1out(a)); Store_field(tuple, 2, conv2out(b)); Store_field(tuple, 3, conv3out(c)); \
    CAMLreturn (tuple); \
}

#define ML_2in_4out(namespace, cname, conv1in, conv2in, cType1out, conv1out, cType2out, conv2out, cType3out, conv3out, cType4out, conv4out, convRes) \
CAMLprim value ml_gi##namespace##_##cname (value arg1, value arg2) \
{ \
    CAMLparam2(arg1, arg2); CAMLlocal1(tuple); \
...
{ \
    CAMLparam3(arg1, arg2, arg3); CAMLlocal1(tuple); \
    cType1out a; cType2out b; tuple = alloc_tuple(3); \
    value res = convRes(cname(conv1in(arg1), conv2in(arg2), conv3in(arg3), &a, &b)); \
    Store_field(tuple, 0, res); Store_field(tuple, 1, conv1out(a)); Store_field(tuple, 2, conv2out(b)); \
    CAMLreturn (tuple); \
}

#define ML_3in_3out(namespace, cname, conv1in, conv2in, conv3in, cType1out, conv1out, cType2out, conv2out, cType3out, conv3out, convRes) \
CAMLprim value ml_gi##namespace##_##cname (value arg1, value arg2, value arg3) \
{ \
    CAMLparam3(arg1, arg2, arg3); CAMLlocal1(tuple); \
    cType1out a; cType2out b; cType3out c; tuple = alloc_tuple(4); \
    value res = convRes(cname(conv1in(arg1), conv2in(arg2), conv3in(arg3), &a, &b, &c)); \
    Store_field(tuple, 0, res); Store_field(tuple, 1, conv1out(a)); Store_field(tuple, 2, conv2out(b)); Store_field(tuple, 3, conv3out(c)); \
    CAMLreturn (tuple); \
}
...
#define ML_6in_1out(namespace, cname, conv1in, conv2in, conv3in, conv4in, conv5in, conv6in, cType1out, conv1out, convRes) \
CAMLprim value ml_gi##namespace##_##cname (value arg1, value arg2, value arg3, value arg4, value arg5, value arg6) \
{ \
    CAMLparam5(arg1, arg2, arg3, arg4, arg5); CAMLxparam1(arg6); CAMLlocal1(tuple); \
    cType1out a; tuple = alloc_tuple(2); \
    value res = convRes(cname(conv1in(arg1), conv2in(arg2), conv3in(arg3), conv4in(arg4), conv5in(arg5), conv6in(arg6), &a)); \
    Store_field(tuple, 0, res); Store_field(tuple, 1, conv1out(a)); \
    CAMLreturn (tuple); \
}

#define ML_1in_1out_discard_ret(namespace, cname, conv1in, cType1out, conv1out, convRes) \
CAMLprim value ml_gi##namespace##_##cname (value arg1) \
{ \
    CAMLparam1(arg1); CAMLlocal1(tuple); \
    cType1out a; \
    cname(conv1in(arg1), &a); \
    CAMLreturn (conv1out(a));\
}

#define ML_1in_2out_discard_ret(namespace, cname, conv1in, cType1out, conv1out, cType2out, conv2out, convRes) \
CAMLprim value ml_gi##namespace##_##cname (value arg1) \
{ \
    CAMLparam1(arg1); CAMLlocal1(tuple); \
    cType1out a; cType2out b; tuple = alloc_tuple(3); \
    cname(conv1in(arg1), &a, &b); \
    Store_field(tuple, 0, conv1out(a)); Store_field(tuple, 1, conv2out(b)); \
    CAMLreturn (tuple); \
}

#define ML_1in_3out_discard_ret(namespace, cname, conv1in, cType1out, conv1out, cType2out, conv2out, cType3out, conv3out, convRes) \
CAMLprim value ml_gi##namespace##_##cname (value arg1) \
{ \
    CAMLparam1(arg1); CAMLlocal1(tuple); \
    cType1out a; cType2out b; cType3out c; tuple = alloc_tuple(4); \
    cname(conv1in(arg1), &a, &b, &c); \
    Store_field(tuple, 0, conv1out(a)); Store_field(tuple, 1, conv2out(b)); Store_field(tuple, 2, conv3out(c)); \
    CAMLreturn (tuple); \
}

#define ML_1in_4out_discard_ret(namespace, cname, conv1in, cType1out, conv1out, cType2out, conv2out, cType3out, conv3out, cType4out, conv4out, convRes) \
CAMLprim value ml_gi##namespace##_##cname (value arg1) \
{ \
    CAMLparam1(arg1); CAMLlocal1(tuple); \
    cType1out a; cType2out b; cType2out c; cType2out d; tuple = alloc_tuple(5); \
    cname(conv1in(arg1), &a, &b, &c, &d); \
    Store_field(tuple, 0, conv1out(a)); Store_field(tuple, 1, conv2out(b)); Store_field(tuple, 2, conv3out(c)); Store_field(tuple, 3, conv4out(d)); \
    CAMLreturn (tuple); \
}

#define ML_2in_1out_discard_ret(namespace, cname, conv1in, conv2in, cType1out, conv1out, convRes) \
CAMLprim value ml_gi##namespace##_##cname (value arg1, value arg2) \
{ \
    CAMLparam2(arg1, arg2); CAMLlocal1(tuple); \
    cType1out a; \
    cname(conv1in(arg1), conv2in(arg2), &a); \
    CAMLreturn (conv1out(a));\
}

#define ML_2in_2out_discard_ret(namespace, cname, conv1in, conv2in, cType1out, conv1out, cType2out, conv2out, convRes) \
CAMLprim value ml_gi##namespace##_##cname (value arg1, value arg2) \
{ \
    CAMLparam2(arg1, arg2); CAMLlocal1(tuple); \
    cType1out a; cType2out b; tuple = alloc_tuple(3); \
    cname(conv1in(arg1), conv2in(arg2), &a, &b); \
    Store_field(tuple, 0, conv1out(a)); Store_field(tuple, 1, conv2out(b)); \
    CAMLreturn (tuple); \
}

#define ML_2in_3out_discard_ret(namespace, cname, conv1in, conv2in, cType1out, conv1out, cType2out, conv2out, cType3out, conv3out, convRes) \
CAMLprim value ml_gi##namespace##_##cname (value arg1, value arg2) \
{ \
    CAMLparam2(arg1, arg2); CAMLlocal1(tuple); \
    cType1out a; cType2out b; cType3out c; tuple = alloc_tuple(4); \
    cname(conv1in(arg1), conv2in(arg2), &a, &b, &c); \
    Store_field(tuple, 0, conv1out(a)); Store_field(tuple, 1, conv2out(b)); Store_field(tuple, 2, conv3out(c)); \
    CAMLreturn (tuple); \
}

#define ML_2in_4out_discard_ret(namespace, cname, conv1in, conv2in, cType1out, conv1out, cType2out, conv2out, cType3out, conv3out, cType4out, conv4out, convRes) \
CAMLprim value ml_gi##namespace##_##cname (value arg1, value arg2) \
{ \
    CAMLparam2(arg1, arg2); CAMLlocal1(tuple); \
    cType1out a; cType2out b; cType3out c; cType4out d; tuple = alloc_tuple(5); \
    cname(conv1in(arg1), conv2in(arg2), &a, &b, &c, &d); \
    Store_field(tuple, 0, conv1out(a)); Store_field(tuple, 1, conv2out(b)); Store_field(tuple, 2, conv3out(c)); Store_field(tuple, 3, conv4out(d)); \
    CAMLreturn (tuple); \
}

#define ML_3in_1out_discard_ret(namespace, cname, conv1in, conv2in, conv3in, cType1out, conv1out, convRes) \
CAMLprim value ml_gi##namespace##_##cname (value arg1, value arg2, value arg3) \
{ \
    CAMLparam3(arg1, arg2, arg3); CAMLlocal1(tuple); \
    cType1out a; tuple = alloc_tuple(2); \
    cname(conv1in(arg1), conv2in(arg2), conv3in(arg3), &a); \
    Store_field(tuple, 0, conv1out(a)); \
    CAMLreturn (tuple); \
}

#define ML_3in_2out_discard_ret(namespace, cname, conv1in, conv2in, conv3in, cType1out, conv1out, cType2out, conv2out, convRes) \
CAMLprim value ml_gi##namespace##_##cname (value arg1, value arg2, value arg3) \
{ \
    CAMLparam3(arg1, arg2, arg3); CAMLlocal1(tuple); \
    cType1out a; cType2out b; tuple = alloc_tuple(3); \
    cname(conv1in(arg1), conv2in(arg2), conv3in(arg3), &a, &b); \
    Store_field(tuple, 0, conv1out(a)); Store_field(tuple, 1, conv2out(b)); \
    CAMLreturn (tuple); \
}

#define ML_3in_3out_discard_ret(namespace, cname, conv1in, conv2in, conv3in, cType1out, conv1out, cType2out, conv2out, cType3out, conv3out, convRes) \
CAMLprim value ml_gi##namespace##_##cname (value arg1, value arg2, value arg3) \
{ \
    CAMLparam3(arg1, arg2, arg3); CAMLlocal1(tuple); \
    cType1out a; cType2out b; cType3out c; tuple = alloc_tuple(4); \
    cname(conv1in(arg1), conv2in(arg2), conv3in(arg3), &a, &b, &c); \
    Store_field(tuple, 0, conv1out(a)); Store_field(tuple, 1, conv2out(b)); Store_field(tuple, 2, conv3out(c)); \
    CAMLreturn (tuple); \
}

#define ML_3in_4out_discard_ret(namespace, cname, conv1in, conv2in, conv3in, cType1out, conv1out, cType2out, conv2out, cType3out, conv3out, cType4out, conv4out, convRes) \
CAMLprim value ml_gi##namespace##_##cname (value arg1, value arg2, value arg3) \
{ \
    CAMLparam3(arg1, arg2, arg3); CAMLlocal1(tuple); \
    cType1out a; cType2out b; cType3out c; cType4out d; tuple = alloc_tuple(5); \
    cname(conv1in(arg1), conv2in(arg2), conv3in(arg3), &a, &b, &c, &d); \
    Store_field(tuple, 0, conv1out(a)); Store_field(tuple, 1, conv2out(b)); Store_field(tuple, 2, conv3out(c)); Store_field(tuple, 3, conv4out(d)); \
    CAMLreturn (tuple); \
}
...
{ \
    CAMLparam4(arg1, arg2, arg3, arg4); CAMLlocal1(tuple); \
    cType1out a; cType2out b; tuple = alloc_tuple(3); \
    cname(conv1in(arg1), conv2in(arg2), conv3in(arg3), conv4in(arg4), &a, &b); \
    Store_field(tuple, 0, conv1out(a)); Store_field(tuple, 1, conv2out(b)); \
    CAMLreturn (tuple); \
}

#define ML_5in_1out_discard_ret(namespace, cname, conv1in, conv2in, conv3in, conv4in, conv5in, cType1out, conv1out, convRes) \
CAMLprim value ml_gi##namespace##_##cname (value arg1, value arg2, value arg3, value arg4, value arg5) \
{ \
    CAMLparam5(arg1, arg2, arg3, arg4, arg5); CAMLlocal1(tuple); \
    cType1out a; \
    cname(conv1in(arg1), conv2in(arg2), conv3in(arg3), conv4in(arg4), conv5in(arg5), &a); \
    CAMLreturn (conv1out(a)); \
}

#define ML_5in_2out_discard_ret(namespace, cname, conv1in, conv2in, conv3in, conv4in, conv5in, cType1out, conv1out, cType2out, conv2out, convRes) \
CAMLprim value ml_gi##namespace##_##cname (value arg1, value arg2, value arg3, value arg4, value arg5) \
{ \
    CAMLparam5(arg1, arg2, arg3, arg4, arg5); CAMLlocal1(tuple); \
    cType1out a; cType2out b; tuple = alloc_tuple(3); \
    cname(conv1in(arg1), conv2in(arg2), conv3in(arg3), conv4in(arg4), conv5in(arg5), &a, &b); \
    Store_field(tuple, 0, conv1out(a)); Store_field(tuple, 1, conv2out(b)); \
    CAMLreturn (tuple); \
}
...
#define Make_Val_option(T, Val) \
value Opt##Val(T* v) { return Val_option(v,Val); }
